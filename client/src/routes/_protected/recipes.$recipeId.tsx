      ...
      <div className="flex flex-col lg:flex-row gap-10 items-center pb-6 border-b border-accent">
        ...
        <div className="flex flex-row lg:flex-col gap-3 shrink-0 w-full lg:w-auto">
          <Button
            ...
            variant="secondary"
            size="xl"
            className="font-semibold shadow-sm flex-1 lg:flex-none flex items-center justify-center gap-2"
          >
          ...
          <Button
            ...
            className="font-semibold shadow-sm flex-1 lg:flex-none flex items-center justify-center gap-2"
          >
            <Bookmark className="size-5 text-yellow-500 fill-current" />
            Save Recipe
          </Button>
        </div>
      </div>
